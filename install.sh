...
git clone https://github.com/sheyden/aws-ec2-ssh.git
...
sudo sed -i 's/IAM_AUTHORIZED_GROUPS=""/IAM_AUTHORIZED_GROUPS="Musoni"/' /opt/import_users.sh
...
sudo sed -i 's/SUDOERSGROUP=""/SUDOERSGROUP="Musoni"/' /opt/import_users.sh
